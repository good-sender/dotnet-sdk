...
namespace GoodSender.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("goodsender-dotnet/0.1.0");
                    ...
                    new Dictionary<string, object> {
                        ...
                        {"description", "Custom server URL"},
                        {
                            "variables", new Dictionary<string, object> {
                                {
                                    "CUSTOM_SERVER_URL", new Dictionary<string, object> {
        ...
        public Configuration(
            ...
            string basePath = "https://api.goodsender.com") : this()
        {
        ...
        {
            string report = "C# SDK (GoodSender) Debug Report:\n";
